...
First Open the config file and modify the variables as needed for the application.
...
type node "page".test.js in the terminal without quotation marks and page = page wanted to test
